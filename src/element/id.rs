...
impl ElementId {
    ...
    pub const fn kind(self) -> ElementKind {
        ...
        unsafe { core::mem::transmute::<u8, ElementKind>(tag) }
    }
    ...
    pub fn view(self) -> Element {
        match self.kind() {
            ...
            ElementKind::Mixed => Element::Mixed(interner().get_mixed(self)),
            ElementKind::Int => Element::Int(interner().get_int(self)),
            ElementKind::Float => Element::Float(interner().get_float(self)),
            ElementKind::String => Element::String(interner().get_string(self)),
            ElementKind::ClassLikeString => Element::ClassLikeString(interner().get_class_like_string(self)),
            ElementKind::Object => Element::Object(interner().get_object(self)),
            ElementKind::Enum => Element::Enum(interner().get_enum(self)),
            ElementKind::ObjectShape => Element::ObjectShape(interner().get_object_shape(self)),
            ElementKind::HasMethod => Element::HasMethod(interner().get_has_method(self)),
            ElementKind::HasProperty => Element::HasProperty(interner().get_has_property(self)),
            ElementKind::Array => Element::Array(interner().get_array(self)),
            ElementKind::List => Element::List(interner().get_list(self)),
            ElementKind::Iterable => Element::Iterable(interner().get_iterable(self)),
            ElementKind::Callable => Element::Callable(interner().get_callable(self)),
            ElementKind::Resource => Element::Resource(interner().get_resource(self)),
            ElementKind::GenericParameter => Element::GenericParameter(interner().get_generic_parameter(self)),
            ElementKind::Variable => Element::Variable(interner().get_variable(self)),
            ElementKind::Reference => Element::Reference(interner().get_reference(self)),
            ElementKind::MemberReference => Element::MemberReference(interner().get_member_reference(self)),
            ElementKind::GlobalReference => Element::GlobalReference(interner().get_global_reference(self)),
            ElementKind::Alias => Element::Alias(interner().get_alias(self)),
