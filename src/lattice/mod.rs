...
//!   `b`).
//!
//! Each takes a [`Codebase`] (class hierarchy lookups, member existence
//! checks, template metadata), a [`LatticeOptions`] value (caller-set
//! knobs like `ignore_null`), and writes diagnostics into a
