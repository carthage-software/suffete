...
/// `Alias`, `Reference`, `MemberReference`, `GlobalReference`,
/// `Conditional`, or `Derived`. The analyser typically needs to call
/// `expand` on such a type before doing further reasoning.
